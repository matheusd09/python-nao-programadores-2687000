...
def seleciona_curso_trilha():
  curso = int(input("Digite o número do curso que você deseja iniciar:\n\
                    1 - Introdução a SQL\n\
...
def percorre_curso(curso_selecionado):
  ...
  print(
    f'Bem vindo ao curso "{curso_atual}"!.\n\
      Você está iniciando o curso no nível: {curso_nivel_atual}.\n..................')
